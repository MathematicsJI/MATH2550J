...
\definecolor{highlighttrans}{RGB}{255,255,153}
...
\begin{frame}{One Constraint}
    ...
    \begin{block}{Problem}
        % Use a more transparent yellow background for highlighting
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{center}
                \begin{tikzpicture}[scale=1.2]
                    ...
                    \node[right, red] at (0.95, 0.75) {$\Delta y$};
                    \node[below, red] at (0.85, 0.55) {$\Delta x$};
                \end{tikzpicture}
            \end{center}
